...
function onToggleMode(mode) {
    localStorage.setItem('MT_BudgetViewMode', mode);
    if (mode === 0) {
        localStorage.setItem('MT_BudgetViewYear', new Date().getFullYear());
...
function saveYear() {
    localStorage.setItem('MT_BudgetViewYear', state.year);
}
...
function onBudgetPageLoad(hardNav) {
    ...
    if (hardNav) {
        localStorage.setItem('MT_BudgetViewMode', '0');
        localStorage.setItem('MT_BudgetViewYear', new Date().getFullYear());
    }
    state.year = parseInt(localStorage.getItem('MT_BudgetViewYear')) || new Date().getFullYear();
    const mode = parseInt(localStorage.getItem('MT_BudgetViewMode') || '0');
